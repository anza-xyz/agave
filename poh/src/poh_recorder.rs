...
mod tests {
    ...
    fn test_would_be_leader_soon() {
        ...
        let bank =
            Bank::new_from_parent_with_bank_forks(bank_forks.as_ref(), bank, &Pubkey::default(), 1);
    ...
    fn test_flush_virtual_ticks() {
        ...
        //create a new bank
        let bank =
            Bank::new_from_parent_with_bank_forks(bank_forks.as_ref(), bank, &Pubkey::default(), 2);
