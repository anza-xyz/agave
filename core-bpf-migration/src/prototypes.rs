//! Prototypes for built-in programs including feature activation and
//! migration.

use {
    crate::config::{CoreBpfMigrationConfig, CoreBpfMigrationTargetType},
...
pub static BUILTINS: &[BuiltinPrototype] = &[
    ...
    testable_prototype!(BuiltinPrototype {
        ...
        enable_feature_id: Some(solana_feature_set::zk_token_sdk_enabled::id()),
    ...
    testable_prototype!(BuiltinPrototype {
        core_bpf_migration_config: None,
        name: loader_v4,
        enable_feature_id: Some(solana_feature_set::enable_program_runtime_v2_and_loader_v4::id()),
    ...
    testable_prototype!(BuiltinPrototype {
        ...
        enable_feature_id: Some(solana_feature_set::zk_elgamal_proof_program_enabled::id()),
...
mod test_only {
    use crate::config::{CoreBpfMigrationConfig, CoreBpfMigrationTargetType};
