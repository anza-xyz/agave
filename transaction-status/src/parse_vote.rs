        ...
        VoteInstruction::InitializeAccountV2(vote_init) => {
            ...
            Ok(ParsedInstructionEnum {
                ...
                info: json!({
                    ...
                    "authorizedVoter": vote_init.authorized_voter.to_string(),
                    "authorizedVoterBlsPubkey": bs58::encode(vote_init.authorized_voter_bls_pubkey).into_string(),
                    "authorizedVoterBlsProofOfPossession": bs58::encode(vote_init.authorized_voter_bls_proof_of_possession).into_string(),
                    "authorizedWithdrawer": vote_init.authorized_withdrawer.to_string(),
        ...
        assert_eq!(
            ...
            ParsedInstructionEnum {
                ...
                info: json!({
                    ...
                    "authorizedVoter": authorized_voter.to_string(),
                    "authorizedVoterBlsPubkey": bs58::encode(authorized_voter_bls_pubkey).into_string(),
                    "authorizedVoterBlsProofOfPossession": bs58::encode(authorized_voter_bls_proof_of_possession).into_string(),
                    "authorizedWithdrawer": authorized_withdrawer.to_string(),
