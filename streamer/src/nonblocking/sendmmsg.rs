...
mod tests {
    ...
    async fn test_send_mmsg_multi_dest() {
        ...
        let reader2 = bind_to_async(IpAddr::V4(Ipv4Addr::LOCALHOST), 0, false)
            .await
            .expect("bind");
    ...
    async fn test_multicast_msg() {
        ...
        let reader3 = bind_to_async(IpAddr::V4(Ipv4Addr::LOCALHOST), 0, false)
            .await
            .expect("bind");
        let addr3 = reader3.local_addr().unwrap();

        let reader4 = bind_to_async(IpAddr::V4(Ipv4Addr::LOCALHOST), 0, false)
            .await
            .expect("bind");
    ...
    async fn test_intermediate_failures_mismatched_bind() {
        ...
        let sender = bind_to_async(IpAddr::V4(Ipv4Addr::UNSPECIFIED), 0, false)
            .await
            .expect("bind");
