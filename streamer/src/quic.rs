    ...
    pub fn report(&self, name: &'static str) {
        ...
        datapoint_info!(
            ...
            (
                ...
                self.total_chunks_first_too_small.swap(0, Ordering::Relaxed),
                i64
            ),
            (
            ...
            (
                ...
                self.total_packets_processed_by_batcher
                    .swap(0, Ordering::Relaxed),
                i64
            ),
            (
