...
impl Default for TestValidatorGenesis {
    fn default() -> Self {
        ...
        Self {
            ...
            tower_storage: Default::default(),
            rent: Default::default(),
            rpc_config: JsonRpcConfig::default_for_test(),
            pubsub_config: Default::default(),
            rpc_ports: Default::default(),
            ...
            validator_exit: Default::default(),
            start_progress: Default::default(),
            authorized_voter_keypairs: Default::default(),
            staked_nodes_overrides: Default::default(),
            max_ledger_shreds: Default::default(),
            max_genesis_archive_unpacked_size: Default::default(),
            geyser_plugin_config_files: Default::default(),
            deactivate_feature_set,
            compute_unit_limit: Default::default(),
            log_messages_bytes_limit: Default::default(),
            transaction_account_lock_limit: Default::default(),
            tpu_enable_udp: DEFAULT_TPU_ENABLE_UDP,
            geyser_plugin_manager: Default::default(),
            admin_rpc_service_post_init: Default::default(),
        }
    }
}
