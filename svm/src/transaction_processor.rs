...
mod tests {
    ...
    #[test_case(0, ThrowLocation::LeadingEdge, 0, 0; "Throw in program 0 before CPI")]
    #[test_case(0, ThrowLocation::TrailingEdge, 0, 0; "Throw in program 0 after CPI")]
    #[test_case(1, ThrowLocation::LeadingEdge, 0, 1; "Throw in program 1 before CPI")]
    #[test_case(1, ThrowLocation::TrailingEdge, 0, 1; "Throw in program 1 after CPI")]
    #[test_case(2, ThrowLocation::LeadingEdge, 0, 2; "Throw in program 2 before CPI")]
    #[test_case(2, ThrowLocation::TrailingEdge, 0, 2; "Throw in program 2 after CPI")]
    #[test_case(3, ThrowLocation::LeadingEdge, 0, 3; "Throw in program 3 before CPI")]
    #[test_case(3, ThrowLocation::TrailingEdge, 0, 3; "Throw in program 3 after CPI")]
    #[test_case(4, ThrowLocation::LeadingEdge, 0, 4; "Throw in program 4 before CPI")]
    #[test_case(4, ThrowLocation::TrailingEdge, 0, 4; "Throw in program 4 after CPI")]
    #[test_case(5, ThrowLocation::LeadingEdge, 0, 5; "Throw in program 5 before CPI")]
    #[test_case(5, ThrowLocation::TrailingEdge, 0, 5; "Throw in program 5 after CPI")]
    #[test_case(6, ThrowLocation::LeadingEdge, 0, 6; "Throw in program 6 before CPI")]
    #[test_case(6, ThrowLocation::TrailingEdge, 0, 6; "Throw in program 6 after CPI")]
    #[test_case(7, ThrowLocation::LeadingEdge, 1, 0; "Throw in program 7 before CPI")]
    #[test_case(7, ThrowLocation::TrailingEdge, 1, 0; "Throw in program 7 after CPI")]
    #[test_case(8, ThrowLocation::LeadingEdge, 1, 1; "Throw in program 8 before CPI")]
    #[test_case(8, ThrowLocation::TrailingEdge, 1, 1; "Throw in program 8 after CPI")]
    #[test_case(9, ThrowLocation::LeadingEdge, 1, 2; "Throw in program 9 before CPI")]
    #[test_case(9, ThrowLocation::TrailingEdge, 1, 2; "Throw in program 9 after CPI")]
    #[test_case(10, ThrowLocation::LeadingEdge, 1, 3; "Throw in program 10 before CPI")]
    #[test_case(10, ThrowLocation::TrailingEdge, 1, 3; "Throw in program 10 after CPI")]
    #[test_case(11, ThrowLocation::LeadingEdge, 1, 4; "Throw in program 11 before CPI")]
    #[test_case(11, ThrowLocation::TrailingEdge, 1, 4; "Throw in program 11 after CPI")]
    #[test_case(12, ThrowLocation::LeadingEdge, 1, 5; "Throw in program 12 before CPI")]
    #[test_case(12, ThrowLocation::TrailingEdge, 1, 5; "Throw in program 12 after CPI")]
    #[test_case(13, ThrowLocation::LeadingEdge, 1, 6; "Throw in program 13 before CPI")]
    #[test_case(13, ThrowLocation::TrailingEdge, 1, 6; "Throw in program 13 after CPI")]
    fn test_instruction_error_carries_responsible_program_account_index(
        ...
        expected_top_level_instruction_index: u8,
        expected_inner_instruction_index: u8,
    ) {
        lazy_static! {
            static ref PROGRAM_ADDRESSES: [Pubkey; 14] =
        ...
        assert_matches!(
            ...
            Some(TransactionError::InstructionError(
                ...
                Some(jj),
                Some(kk),
            )) if ii == expected_top_level_instruction_index && jj == account_index_of_program_that_should_throw_exception && kk == expected_inner_instruction_index,
            "Expected the error to be attributable to the program with account index: \
            {account_index_of_program_that_should_throw_exception} at top level instruction index \
            {} and inner instruction index {}.",
            expected_top_level_instruction_index,
