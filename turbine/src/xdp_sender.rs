...
use {
    agave_xdp::xdp_retransmitter::{XdpAddrs, XdpSender as AyaXdpSender, XdpTransmitItem},
    bytes::Bytes,
...
impl XdpSender {
    pub fn new(sender: AyaXdpSender, src_addr: SocketAddrV4) -> Self {
    ...
    pub fn try_send(
        ...
        self.sender.try_send(
            sender_index,
            XdpTransmitItem::new(self.src_addr, addr, payload),
        )
    }
}
