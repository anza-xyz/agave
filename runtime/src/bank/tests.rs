...
use {
    ...
    solana_compute_budget::{
        ...
        compute_budget_limits::{self, MAX_COMPUTE_UNIT_LIMIT, get_prioritization_fee_for_test},
    },
...
fn test_calculate_fee_compute_units() {
    ...
    for requested_compute_units in [
        ...
        assert_eq!(
            fee,
            lamports_per_signature + get_prioritization_fee_for_test(PRIORITIZATION_FEE_RATE, requested_compute_units as u64)
        );
    }
}
...
fn test_calculate_prioritization_fee() {
    ...
    let prioritization_fee = get_prioritization_fee_for_test(request_unit_price, request_units as u64);
