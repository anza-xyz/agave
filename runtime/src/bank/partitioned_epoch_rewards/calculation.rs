...
mod tests {
    use {
        ...
        crate::{
            bank::{
                ...
                BankLeader, RewardInfo, VoteReward,
            },
    ...
    fn apply_epoch_operations(mut bank: Bank, op: EpochOperations) -> Bank {
        ...
        bank = Bank::new_from_parent(prev_bank.clone(), BankLeader::new_unique(), slot);
    ...
    fn test_recalculate_stake_rewards() {
        ...
        let bank = Arc::new(Bank::new_from_parent(bank, BankLeader::default(), new_slot));
    ...
    fn test_recalculate_partitioned_rewards() {
        ...
        let new_slot = bank.slot() + 1;
        let mut bank = Bank::new_from_parent(bank, BankLeader::default(), new_slot);
        ...
        // Advance to first distribution slot
        let mut bank =
            Bank::new_from_parent(Arc::new(bank), BankLeader::default(), SLOTS_PER_EPOCH + 1);
        ...
        // Advance to last distribution slot
        let mut bank =
            Bank::new_from_parent(Arc::new(bank), BankLeader::default(), SLOTS_PER_EPOCH + 2);
        bank.recalculate_partitioned_rewards_if_active(|| &thread_pool);
    ...
    fn test_epoch_rewards_cache_multiple_forks() {
        ...
        let bank_fork1 =
            Bank::new_from_parent(Arc::clone(&bank), BankLeader::default(), next_epoch_slot);
        {
        ...
        let bank_fork2 = Bank::new_from_parent(bank, BankLeader::default(), next_epoch_slot);
        {
