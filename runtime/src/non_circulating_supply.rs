...
pub fn non_circulating_accounts() -> Vec<Pubkey> {
    [
        ...
        solana_pubkey::pubkey!("8andGYFjav6ANDXvzYcxs449Aub3AxYv4vYpk89zRDwgj7"),
        ...
        solana_pubkey::pubkey!("CUsageMFi49kzoDqtdU8NvQ4Bq3sbtJygjKDAXJ45nmAi"),
        ...
        solana_pubkey::pubkey!("GEWSkfWgHkpiLbeKaAnwvqnECGdRNf49at5nFccVery7c"),
        ...
        solana_pubkey::pubkey!("HuqDWJobFhAEWh6aWdsDVUqsjRket5DYXMYyDYtD8hdN"),
...
pub fn withdraw_authority() -> Vec<Pubkey> {
    [
        ...
        solana_pubkey::pubkey!("FdGYQdiRky8NZzN9wZtczTBcWLYYRXrJ3LMDhqDOn5rM"),
