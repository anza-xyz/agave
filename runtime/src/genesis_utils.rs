...
pub fn create_genesis_config_with_leader_ex_no_features(
    ...
    add_stake_config_genesis_account(&mut genesis_config);
    add_epoch_rewards_genesis_account(&mut genesis_config);
...
#[allow(deprecated)]
pub fn add_stake_config_genesis_account(genesis_config: &mut GenesisConfig) -> u64 {
    // HANA check does this serialize to [] or to [0; 8]
...
pub fn add_epoch_rewards_genesis_account(genesis_config: &mut GenesisConfig) -> u64 {
