...
impl From<DeserializableVersionedBank> for BankFieldsToDeserialize {
    fn from(dvb: DeserializableVersionedBank) -> Self {
        BankFieldsToDeserialize {
            ...
            slot_hashes: dvb.slot_hashes,
            vote_only_hash: dvb.vote_only_hash,
            parent_hash: dvb.parent_hash,
            parent_vote_only_hash: dvb.parent_vote_only_hash,
...
impl From<BankFieldsToSerialize> for SerializableVersionedBank {
    fn from(rhs: BankFieldsToSerialize) -> Self {
        Self {
            ...
            slot_hashes: rhs.slot_hashes,
            vote_only_hash: rhs.vote_only_hash,
            parent_hash: rhs.parent_hash,
            parent_vote_only_hash: rhs.parent_vote_only_hash,
