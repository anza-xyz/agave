...
fn streaming_snapshot_dir_files(
    ...
    let snapshot_bank_path = snapshot_file_path.into();
    let snapshot_bank_file_info = FileInfo::new_from_path(snapshot_bank_path)?;
    file_sender.send(snapshot_bank_file_info)?;
    let snapshot_version_path = snapshot_version_path.into();
...
mod tests {
    ...
    fn test_snapshot_version_from_file_under_limit() {
        ...
        let file_info = FileInfo::new_from_path_and_file(path, file.into_file()).unwrap();
