...
use {
    ...
    agave_snapshots::{error::SnapshotResult, snapshot_config::SnapshotConfig, SnapshotInterval},
...
fn make_full_snapshot_archive(bank: &Bank, snapshot_config: &SnapshotConfig) -> SnapshotResult<()> {
    info!(
