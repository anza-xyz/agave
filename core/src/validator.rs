...
use {
    crate::{
        ...
        tpu::{Tpu, TpuChannels, TpuConfig, TpuInfra, TpuSockets},
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        let tpu = Tpu::new_with_client(
            ...
            TpuChannels {
                ...
                verified_voter_slots_sender: verified_vote_sender,
            ...
            TpuConfig {
                ...
                tracer_thread_hdl: tracer_thread,
                scheduler_bindings: config.enable_scheduler_bindings.then(|| {
                    (
