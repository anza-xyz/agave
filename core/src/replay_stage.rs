...
pub(crate) mod tests {
    ...
    fn test_update_propagation_status() {
        ...
        Bank::new_from_parent_with_bank_forks(&bank_forks_arc, bank9, &Pubkey::default(), 10);
    ...
    fn test_chain_update_propagation_status() {
        ...
        for i in 1..=10 {
            ...
            let bank = Bank::new_from_parent(parent_bank, &Pubkey::default(), i);
    ...
    fn test_initialize_progress_and_fork_choice_with_duplicates() {
        ...
        */
        ...
        let bank1 = {
            let bank =
                Bank::new_from_parent(bank0.clone_without_scheduler(), &Pubkey::default(), 1);
            bank_forks.write().unwrap().insert(bank)
        };
        confirm_full_slot(
            &blockstore,
