                ...
                if let Ok(tx_cost) = tx_cost {
                    ...
                    match transaction_committed_details {
                        CommitTransactionDetails::Committed {
                            ...
                            let estimated_cost_units = tx_cost.sum();
                            let actual_cost_units = match actual_load_and_execution_units
                                .cmp(&estimated_load_and_execution_units)
                            {
                                std::cmp::Ordering::Equal => estimated_cost_units,
                                std::cmp::Ordering::Greater => estimated_cost_units.saturating_add(
                                    actual_load_and_execution_units
                                        - estimated_load_and_execution_units,
                                ),
                                std::cmp::Ordering::Less => estimated_cost_units.saturating_sub(
                                    estimated_load_and_execution_units
                                        - actual_load_and_execution_units,
                                ),
                            };
