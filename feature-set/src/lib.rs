...
pub static FEATURE_NAMES: LazyLock<AHashMap<Pubkey, &'static str>> = LazyLock::new(|| {
    [
        ...
        (enable_sbpf_v1_deployment_and_execution::id(), "SIMD-0166: Enables deployment and execution of SBPFv1 programs"),
        (enable_sbpf_v2_deployment_and_execution::id(), "SIMD-0173 and SIMD-0174: Enables deployment and execution of SBPFv2 programs"),
        (enable_sbpf_v3_deployment_and_execution::id(), "SIMD-0178 and SIMD-0189: Enables deployment and execution of SBPFv3 programs"),
