...
pub mod replace_ata_with_p_ata {
    ...
    // Trimmed SHA-256 of pinocchio/program from solana-program/associated-token-account@2dc55ee
    // built with platform-tools v1.54. The same ELF is the runtime test fixture pata-9eca7.so.
