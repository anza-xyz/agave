...
mod tests {
    use {
        ...
        crate::{
            ...
            vote_state::{
                self, create_v4_account_with_authorized, Lockout, TowerSync, Vote, VoteAuthorize,
                VoteAuthorizeCheckedWithSeedArgs, VoteAuthorizeWithSeedArgs, VoteInit,
                VoteStateHandle, VoteStateUpdate, VoteStateV3, VoteStateV4, VoteStateVersions,
            },
        },
        bincode::serialize,
        solana_account::{
    ...
    fn test_vote_update_commission(vote_state_v4_enabled: bool) {
        ...
        if vote_state_v4_enabled {
            ...
            assert_eq!(
                ...
                (u8::MAX as u16).saturating_mul(100),
            );
        } else {
            let vote_state = VoteStateV3::deserialize(accounts[0].data()).unwrap();
