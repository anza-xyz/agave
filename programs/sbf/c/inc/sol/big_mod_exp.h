...
#ifndef SOL_SBPFV3
uint64_t sol_big_mod_exp(const SolBigModExpParams *, uint8_t *);
#else
typedef uint64_t(*sol_big_mod_exp_pointer_type)(const SolBigModExpParams *, uint8_t *);
static uint64_t sol_big_mod_exp(const SolBigModExpParams * arg1, uint8_t * arg2) {
