...
pub struct BytesChannelReader {
    ...
    receiver: Receiver<MultiBytes>,
}

impl BytesChannelReader {
    pub fn new(receiver: Receiver<MultiBytes>) -> Self {
        Self {
...
impl<R: Read> ArchiveChunker<R> {
    ...
    pub fn decode_and_send_chunks(mut self, chunk_sender: Sender<MultiBytes>) -> io::Result<()> {
