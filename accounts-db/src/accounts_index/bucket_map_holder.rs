...
pub mod tests {
    ...
    fn test_max_evictions_threshold() {
        ...
        assert_eq!(test.max_evictions_for_threshold(2000, 0.50), Some(1776));

        assert_eq!(test.max_evictions_for_threshold(1500, 0.50), Some(1276));

        assert_eq!(test.max_evictions_for_threshold(896, 0.50), Some(672));
    ...
    fn test_max_evictions_threshold_multiple_bins() {
        ...
        assert_eq!(test.max_evictions_for_threshold(500, 0.50), Some(444));

        assert_eq!(test.max_evictions_for_threshold(300, 0.50), Some(244));

        assert_eq!(test.max_evictions_for_threshold(224, 0.50), Some(168));

        assert_eq!(test.max_evictions_for_threshold(100, 0.50), Some(44));
