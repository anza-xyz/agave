...
mod tests {
    use {
        ...
        solana_runtime::{bank::BankLeader, commitment::BlockCommitmentCache, dependency_tracker},
    ...
    fn test_process_notification() {
        ...
        let bank3 = bank_forks.read().unwrap().get(3).unwrap();
        let bank4 = Bank::new_from_parent(bank3, BankLeader::default(), 4);
        ...
        let bank5 = Bank::new_from_parent(bank4, BankLeader::default(), 5);
        ...
        let bank5 = bank_forks.read().unwrap().get(5).unwrap();
        let bank6 = Bank::new_from_parent(bank5, BankLeader::default(), 6);
        bank_forks.write().unwrap().insert(bank6);
        let bank5 = bank_forks.read().unwrap().get(5).unwrap();
        let bank7 = Bank::new_from_parent(bank5, BankLeader::default(), 7);
