...
pub mod tests {
    ...
    fn test_get_health() {
        ...
        let bank4 = Arc::new(Bank::new_from_parent(bank0, BankLeader::default(), 4));
        ...
        let bank5 = Arc::new(Bank::new_from_parent(bank4, BankLeader::default(), 5));
        optimistically_confirmed_bank.write().unwrap().bank = bank5.clone();
        assert_eq!(health.check(), RpcHealthStatus::Ok);

        // Node now up with tip of cluster
        let bank15 = Arc::new(Bank::new_from_parent(bank5, BankLeader::default(), 15));
        ...
        let bank16 = Arc::new(Bank::new_from_parent(bank15, BankLeader::default(), 16));
