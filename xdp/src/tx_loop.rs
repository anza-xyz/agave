...
pub struct PartialTxLoop<U: Umem> {
    cpu_id: usize,
    queue_id: QueueId,
    zero_copy: bool,
    src_mac: MacAddress,
...
impl PartialTxLoop<OwnedUmem<PageAlignedMemory>> {
    pub fn new(
        cpu_id: usize,
        queue_id: QueueId,
        config: TxLoopConfig,
        dev: &NetworkDevice,
    ) -> PartialTxLoop<OwnedUmem<PageAlignedMemory>> {
        let TxLoopConfig {
            zero_copy,
            src_mac,
            src_ip,
    ...
    pub fn finish(self) -> TxLoop<OwnedUmem<PageAlignedMemory>> {
        let PartialTxLoop {
            cpu_id,
            queue_id,
            zero_copy,
