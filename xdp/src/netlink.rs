...
use {
    libc::{
        ...
        NLA_ALIGNTO, NLA_TYPE_MASK, NLM_F_DUMP, NLM_F_MULTI, NLM_F_REQUEST, NLMSG_DONE,
        NLMSG_ERROR, RT_TABLE_MAIN, RTA_DST, RTA_GATEWAY, RTA_IIF, RTA_OIF, RTA_PREFSRC,
        RTA_PRIORITY, RTA_TABLE, RTM_GETNEIGH, RTM_GETROUTE, RTM_NEWNEIGH, RTM_NEWROUTE, SO_RCVBUF,
        SOCK_RAW, SOL_NETLINK, SOL_SOCKET, nlattr, nlmsgerr, nlmsghdr, recv, send, setsockopt,
        sockaddr_nl, socket,
    },
    std::{
        collections::HashMap,
