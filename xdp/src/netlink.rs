...
use {
    libc::{
        ...
        AF_INET, AF_INET6, AF_NETLINK, ARPHRD_ETHER, ARPHRD_IPGRE, ARPHRD_LOOPBACK, IFLA_IFNAME,
        IFLA_INFO_DATA, IFLA_LINKINFO, IFNAMSIZ, NDA_DST, NDA_LLADDR, NETLINK_EXT_ACK,
        NETLINK_ROUTE, NLA_ALIGNTO, NLA_TYPE_MASK, NLMSG_DONE, NLMSG_ERROR, NLM_F_DUMP,
        NLM_F_MULTI, NLM_F_REQUEST, RTA_DST, RTA_GATEWAY,
        RTA_IIF, RTA_OIF, RTA_PREFSRC, RTA_PRIORITY, RTA_TABLE, RTM_GETLINK,
        RTM_GETNEIGH, RTM_GETROUTE, RTM_NEWLINK, RTM_NEWNEIGH, RTM_NEWROUTE,
        RT_TABLE_MAIN, SOCK_RAW, SOL_NETLINK, SOL_SOCKET, SO_RCVBUF,
    },
    std::{
        collections::HashMap,
        io, mem,
