...
mod tests {
    ...
    #[test]
    fn test_default_bincode_deserialize_handles_v2_bytes() {
        let v2 = blockstore_meta::SlotMetaV2 {
            slot: 1,
            consumed: 0,
            received: 0,
        ...
        let v2_bytes = bincode::serialize(&v2).unwrap();
        let deserialized = bincode::deserialize::<blockstore_meta::SlotMeta>(&v2_bytes).unwrap();
        ...
        let deserialized = bincode::deserialize::<blockstore_meta::SlotMeta>(&v3_bytes).unwrap();
