...
///
/// [`SlotMeta::next_slots`] usually contains one child, and occasionally two.
...
///
/// Note that [`SlotMeta::next_slots`] is not strictly bounded to a maximum two
/// children; in rare cases, more than two children may be stored.
