use crate::shred::{
    CODING_SHREDS_PER_FEC_BLOCK, DATA_SHREDS_PER_FEC_BLOCK, Error, MAX_CODE_SHREDS_PER_SLOT,
    MAX_DATA_SHREDS_PER_SLOT, ShredType, traits::ShredCode as ShredCodeTrait,
};
