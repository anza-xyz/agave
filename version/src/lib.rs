...
impl TryFrom<ClientId> for u16 {
    ...
    fn try_from(client: ClientId) -> Result<Self, Self::Error> {
        match client {
            ...
            ClientId::AgaveBam => Ok(5u16),
            ClientId::Sig => Ok(6u16),
            ClientId::Firedancer => Ok(7u16),
...
mod test {
    ...
    fn test_client_id() {
        ...
        assert_eq!(ClientId::from(5u16), ClientId::AgaveBam);
        assert_eq!(ClientId::from(6u16), ClientId::Sig);
        assert_eq!(ClientId::from(7u16), ClientId::Firedancer);
        ...
        assert_eq!(u16::try_from(ClientId::AgaveBam), Ok(5u16));
        assert_eq!(u16::try_from(ClientId::Sig), Ok(6u16));
        assert_eq!(u16::try_from(ClientId::Firedancer), Ok(7u16));
