...
// HANA these can all be deprecated as they are superceded by sol_get_sysvar
// but marking #[deprecated] does nothing
...
// HANA this cant go through sol_get_sysvar but i wonder if we have a mechanism to remove it at all
