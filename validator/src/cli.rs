use {
    ...
    solana_gossip::cluster_info::DEFAULT_NUM_ALPENGLOW_QUIC_ENDPOINTS,
    solana_hash::Hash,
...
pub struct DefaultArgs {
    ...
    pub num_alpenglow_endpoints: String,
...
impl DefaultArgs {
    pub fn new() -> Self {
        DefaultArgs {
            ...
            num_alpenglow_endpoints: DEFAULT_NUM_ALPENGLOW_QUIC_ENDPOINTS.to_string(),
