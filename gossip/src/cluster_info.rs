...
pub struct Sockets {
    ...
    pub tvu_quic: UdpSocket,          // quic read only
    pub tpu: Vec<UdpSocket>,          // udp read only
    pub tpu_forwards: Vec<UdpSocket>, // udp read only
    ...
    pub vortexor_receivers: Option<Vec<UdpSocket>>, // udp read only
}
